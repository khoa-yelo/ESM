...
def embed_protein(client, protein_seq, middle_layer=12):
    """
    Embed a protein sequence using the ESM-C model.
    Args:
        client (ESMC): The ESMC client.
        protein_seq (str): The protein sequence to embed.
        middle_layer (int): The middle layer to extract logits from.
    Returns:
        dict: A dictionary containing the max and mean embeddings of last layer and middle layer.
    """
...
def main():
    """
    Main function to run the ESM-C protein embedding script.
    """
